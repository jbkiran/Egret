    ...
    return (
        <aside className="flex flex-col md:w-[250px] sm:w-full gap-3">
            ...
            <div className="bg-[#2B2B2B] md:w-[250px] sm:w-full rounded-2xl shadow-lg flex-1 p-4 text-center flex flex-col relative">
                <h2 className="text-xl font-bold text-[#F0ECE2]">Kiran JB</h2>
                <p className="text-[#A9A9A9]">Fullstack Developer</p>
                ...
                <div className="space-y-2 text-sm text-[#F0ECE2]">
                    ...
                    <div className="flex gap-x-3 justify-between">
                        ...
                        <a href="mailto:hey@smith.studio" className="text-blue-400 hover:underline">hey@smith.studio</a>
                    </div>
                    <div className="flex gap-x-3 justify-between">
                        <span className="w-24 font-semibold  text-left">Phone:</span>
                        <span className="text-gray-400">+77 12 34 56 78</span>
                    </div>
                    <div className="flex gap-x-3 justify-between">
                        <span className="w-24 font-semibold text-left">Location:</span>
                        <a href="javascript:void(0)" className="text-blue-400 hover:underline">Thiruvananthapuram</a>
                    </div>
                </div>
                ...
                <div className="relative sm:absolute sm:bottom-3 sm:left-3 sm:right-3">
                    <button type="button" className="w-full flex justify-between text-white bg-[#FF5E0E] hover:bg-[#B22222] font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center">
